...
INSERT INTO "new_Crypto" ("buyTrigger", "currentPrice", "gainLossPct", "id", "lastBuyPrice", "lastSellDate", "lastSellPrice", "lastUpdated", "status", "symbol", "totalHoldings") SELECT "buyTrigger", "currentPrice", "gainLossPct", "id", "lastBuyPrice", "lastSellDate", "lastSellPrice", "lastUpdated", "status", "symbol", "totalHoldings" FROM "Crypto";
DROP TABLE "Crypto";
